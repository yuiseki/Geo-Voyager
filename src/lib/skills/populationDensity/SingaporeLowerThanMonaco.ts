...
/**
 * Checks if Singapore's population density is lower than Monaco's.
 * @returns Promise resolving to a boolean indicating whether Singapore's population density is lower.
 */
const isPopulationDensityOfSingaporeLowerThanMonaco =
