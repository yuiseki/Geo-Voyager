...
/**
 * Checks if Maldives's population density is lower than Singapore's.
 * @returns Promise resolving to a boolean indicating whether Maldives's population density is lower.
 */
const isPopulationDensityOfMaldivesLowerThanSingapore =
