...
/**
 * Checks if Monaco's population density is higher than Bahrain's.
 * @returns Promise resolving to a boolean indicating whether Monaco's population density is higher.
 */
const isPopulationDensityOfMonacoHigherThanBahrain =
  async (): Promise<boolean> => {
    ...
    return monacoPopulationDensity > bahrainPopulationDensity;
  };
