...
/**
 * Checks if Singapore's population density is higher than Bahrain's.
 * @returns Promise resolving to a boolean indicating whether Singapore's population density is higher.
 */
const isPopulationDensityOfSingaporeHigherThanBahrain =
  async (): Promise<boolean> => {
    ...
    return singaporePopulationDensity > bahrainPopulationDensity;
  };
