...
/**
 * Checks if Singapore's population density is higher than Japan's.
 * @returns Promise resolving to a boolean indicating whether Singapore's population density is higher.
 */
const isPopulationDensityOfSingaporeHigherThanJapan =
  async (): Promise<boolean> => {
    ...
    return singaporePopulationDensity > japanPopulationDensity;
  };
