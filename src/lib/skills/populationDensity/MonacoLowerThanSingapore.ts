...
/**
 * Checks if Monaco's population density is lower than Singapore's.
 * @returns Promise resolving to a boolean indicating whether Monaco's population density is lower.
 */
const isPopulationDensityOfMonacoLowerThanSingapore =
