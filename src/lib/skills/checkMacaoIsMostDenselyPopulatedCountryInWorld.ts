...
const checkMacaoIsMostDenselyPopulatedCountryInWorld =
  async (): Promise<boolean> => {
    ...
    return mostDenselyPopulatedCountry.includes("Macao");
  };

export default checkMacaoIsMostDenselyPopulatedCountryInWorld;
