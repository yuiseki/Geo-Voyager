// description: 東京都において、学校の数が最も多い行政区が多摩地域内の武蔵野市であることを確認する。
// file_path: src/lib/skills/admins/Japan/Tokyo/checkMatsudoIsMostSchoolsWardInTokyo.ts
...
const checkMatsudoIsMostSchoolsWardInTokyo = async (): Promise<boolean> => {
  const wardWithMostSchools = await getAdminWithMostSchoolsInTokyo();
  return wardWithMostSchools.includes("武蔵野市");
};

export default checkMatsudoIsMostSchoolsWardInTokyo;