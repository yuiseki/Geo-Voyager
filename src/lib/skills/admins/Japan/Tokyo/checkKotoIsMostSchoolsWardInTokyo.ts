// description: 東京都において、学校が最も多い行政区が江東区であることを確認する。
// file_path: src/lib/skills/admins/Japan/Tokyo/checkKotoIsMostSchoolsWardInTokyo.ts
...
const checkKotoIsMostSchoolsWardInTokyo = async (): Promise<boolean> => {
  ...
  return wardWithMostSchools.includes("江東区");
};

export default checkKotoIsMostSchoolsWardInTokyo;