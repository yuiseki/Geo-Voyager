// description: 東京都において、学校の数が最も多い行政区が品川区であることを確認する。
// file_path: src/lib/skills/admins/Japan/Tokyo/checkShinagawaIsMostSchoolsWardInTokyo.ts
...
const checkShinagawaIsMostSchoolsWardInTokyo = async (): Promise<boolean> => {
  ...
  return wardWithMostSchools.includes("品川区");
};

export default checkShinagawaIsMostSchoolsWardInTokyo;
