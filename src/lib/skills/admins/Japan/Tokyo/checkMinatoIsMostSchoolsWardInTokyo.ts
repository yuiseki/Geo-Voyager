// description: 東京都において、学校の数が最も多い行政区が港区であることを確認する。
// file_path: src/lib/skills/admins/Japan/Tokyo/checkMinatoIsMostSchoolsWardInTokyo.ts
...
export default checkMinatoIsMostSchoolsWardInTokyo;
