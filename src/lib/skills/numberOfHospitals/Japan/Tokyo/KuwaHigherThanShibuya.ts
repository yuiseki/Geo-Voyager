 ...
 */
const isNumberOfHospitalsInMinatoLowerThanShibuya =
...
out count;`;
    ...
    const numberOfMinatoHospitals =
      resultMinatoHospitals.elements[0].tags.total;
...
nwr["amenity"="hospital"](area.inner)(area.outer);
out count;`;
    const resultShibuyaHospitals = await fetchOverpassData(
    ...
    const numberOfShibuyaHospitals =
      resultShibuyaHospitals.elements[0].tags.total;
