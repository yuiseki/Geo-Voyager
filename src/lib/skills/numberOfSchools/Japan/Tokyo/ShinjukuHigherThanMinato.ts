// description: 東京都新宿区の学校の数が東京都港区よりも多いことを確認する。
// file_path: src/lib/skills/numberOfSchools/Japan/Tokyo/ShinjukuHigherThanMinato.ts
...
/**
 * Compares the number of schools in Shinjuku Ward and Minato Ward.
 * @returns True if Shinjuku Ward has more schools than Minato Ward, otherwise false.
 */
async function isShinjukuHigherThanMinato(): Promise<boolean> {
  ...
  return shinjukuSchoolCount > minatoSchoolCount;
}

export default isShinjukuHigherThanMinato;