// description: 東京都新宿区の学校の数が東京都大田区の学校の数より少ないことを確認する。
// file_path: src/lib/skills/numberOfSchools/Japan/Tokyo/ShinjukuLowerThanTaito.ts
...
/**
 * Compares the number of schools in Shinjuku Ward and Taito Ward.
 * @returns True if Shinjuku Ward has fewer schools than Taito Ward, otherwise false.
 */
async function isShinjukuLowerThanTaito(): Promise<boolean> {
  ...
  return shinjukuSchoolCount < taitoSchoolCount;
}

export default isShinjukuLowerThanTaito;