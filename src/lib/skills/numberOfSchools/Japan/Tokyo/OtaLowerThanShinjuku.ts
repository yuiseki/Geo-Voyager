// description: 東京都墨田区の学校の数が東京都新宿区の学校の数より少ないことを確認する。
// file_path: src/lib/skills/numberOfSchools/Japan/Tokyo/OtaLowerThanShinjuku.ts
...
/**
 * Compares the number of schools in Ota Ward and Shinjuku Ward.
 * @returns True if Ota Ward has fewer schools than Shinjuku Ward, otherwise false.
 */
async function isOtaLowerThanShinjuku(): Promise<boolean> {
  ...
  return otaSchoolCount < shinjukuSchoolCount;
}

export default isOtaLowerThanShinjuku;