// description: 東京都中央区の学校の数が東京都新宿区の学校の数より少ないことを確認する。
// file_path: src/lib/skills/numberOfSchools/Japan/Tokyo/ChuoLowerThanShinjuku.ts
...
/**
 * Compares the number of schools in Chuo Ward and Shinjuku Ward.
 * @returns True if Chuo Ward has fewer schools than Shinjuku Ward, otherwise false.
 */
async function isChuoLowerThanShinjuku(): Promise<boolean> {
  ...
  return chuoSchoolCount < shinjukuSchoolCount;
}

export default isChuoLowerThanShinjuku;