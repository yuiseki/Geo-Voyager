// description: 東京都中央区の学校の数が東京都新宿区よりも多いことを確認する。
// file_path: src/lib/skills/numberOfSchools/Japan/Tokyo/CentralHigherThanShinjuku.ts
...
/**
 * Compares the number of schools in Central Ward and Shinjuku Ward.
 * @returns True if Central Ward has more schools than Shinjuku Ward, otherwise false.
 */
async function isCentralHigherThanShinjuku(): Promise<boolean> {
  ...
  return centralSchoolCount > shinjukuSchoolCount;
}

export default isCentralHigherThanShinjuku;